...
fetch('http://www.omdbapi.com/?i=tt3896198&apikey=d59c621a')
    .then(res => res.json())
...
async function singleMovie() {
    ...
    <div class="movie-details">
        <div class="details-header">
            ...
            <div class="dh-rs">
                <i class="fa-regular fa-heart" onClick=addTofavorites('${id}') style="cursor: pointer;"></i>
            </div>
        </div>
...
async function addTofavorites(id) {
    ...
    alert('Movie Added to Fovoritelist!');
}
...
async function removeFromfavorites(id) {
    ...
    alert('Movie Removed from Fovoritelist');
        ...
        <div class="fav-item">
            ...
            <div class="fav-details">
                <div class="fav-details-box">
                    ...
                    <div>
                        <i class="fa-solid fa-award" style="cursor:pointer;" onClick=addTofavorites('${id}')></i>
                    </div>
                </div>
            </div>
        </div>
